...
The Sonr Highway modules are the core building blocks for creating decentralized, privacy-preserving, and user orientated apps. Each module corresponds with an associated blockchain keeper which allows developers to perform the inputed action. For more information on the technical detail behind the modules, please refer to [our technology](https://www.notion.so/86b56e15b51747d5b29dde4005f069e6).
